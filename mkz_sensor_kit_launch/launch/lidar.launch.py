...
#
# After this change you no longer need to run:
#   ros2 run rclcpp_components component_container_mt ...
# manually; the container is created here.
...
def generate_launch_description():
    ...
    container = ComposableNodeContainer(
        ...
        executable="component_container_mt",  # always multithreaded, as you ran manually
